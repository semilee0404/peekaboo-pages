...
const weeklyReports = [
  {
    ...
    insights: {
      good: [
        ...
        "4/1(수) 자사몰 일매출 606만, 주간 최고 — 신상 4종(샤인·샌디·링고·이븐) 오픈 효과"
      ],
      check: [
  ...
  },
  {
    ...
    summary: "전체 매출 5,052만원, 전주 대비 +11.6%. 신상 5종 오픈 효과로 자사몰 견인. 쿠팡은 납품금액 기준.",
    channels: [
      { name: "쿠팡", revenue: 17783300, prevWeek: 22828300, prevYear: 19196300, ratio: 35.2 },
      { name: "자사몰", revenue: 30741475, prevWeek: 20901113, prevYear: null, ratio: 60.8 },
      { name: "스마트스토어", revenue: 1232700, prevWeek: 1003600, prevYear: null, ratio: 2.4 },
      { name: "카카오선물하기", revenue: 624300, prevWeek: 465500, prevYear: null, ratio: 1.2 },
      { name: "롯데온", revenue: 137700, prevWeek: 71400, prevYear: null, ratio: 0.3 }
    ],
    total: { revenue: 50519475, prevWeek: 45269913, prevYear: null },
    overseas: {
      sellers: [
        {
          name: "도매주문관리",
    ...
    insights: {
      good: [
        ...
        "해외 수출 Hipeekaboo 전월대비 +564.6% 급성장"
      ],
      check: [
        "쿠팡 납품 전주대비 -22.1%, 전년대비 -7.4% 감소",
        "스마트스토어 환불 32.9% — 루루·이브 래쉬가드 품절 (원인 파악 완료)",
        "도매주문관리 수출 전월 -18.6%, 전년 -32.0% 감소"
      ]
    },
    status: [
      { type: "confirmed", text: "5채널 셀러센터 실수치 + 쿠팡 납품금액(서플라이허브) 기준" },
      { type: "confirmed", text: "해외 수출 데이터 이지어드민 판매처상품매출통계 기준" },
