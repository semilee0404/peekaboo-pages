...
const weeklyReports = [
  {
    ...
    summary: "5월 1주차(4/27~5/3)는 쿠팡·자사몰·네이버·카카오·롯데온 기준 확인 매출 5,399만원. 쿠팡 Ads 확인 매출은 4,016만원.",
    channels: [
      { name: "쿠팡", revenue: 18574000, prevWeek: 25998030, prevYear: 22428500, ratio: 34.4 },
      { name: "자사몰", revenue: 31489953, prevWeek: 20554297, prevYear: null, ratio: 58.3 },
      { name: "스마트스토어", revenue: 3011300, prevWeek: 2942980, prevYear: 1675980, ratio: 5.6 },
      { name: "카카오선물하기", revenue: 752700, prevWeek: 111500, prevYear: 707410, ratio: 1.4 },
      { name: "롯데온", revenue: 163200, prevWeek: 252600, prevYear: null, ratio: 0.3 }
    ],
    total: { revenue: 53991153, prevWeek: 49859407, prevYear: null },
    coupangGmv: { revenue: 40157950, fee: 35 },
    cafe24Daily: [
      { day: "월", date: "4/27", revenue: 3584866 },
      { day: "화", date: "4/28", revenue: 2896558 },
      { day: "수", date: "4/29", revenue: 2208792 },
      { day: "목", date: "4/30", revenue: 1935022 },
      { day: "금", date: "5/1", revenue: 5696688 },
      { day: "토", date: "5/2", revenue: 4854916 },
      { day: "일", date: "5/3", revenue: 4940979 }
    ],
    cafe24Top10: [
    ...
    insights: {
      good: [
        "쿠팡·자사몰·네이버·카카오·롯데온 합산 4/27~5/3 기준 확인 매출 53,991,153원",
        "쿠팡 납품 4/27~5/3 총단가 18,574,000원",
        "쿠팡 납품 전년 동요일 2025-04-28~2025-05-04 총단가 22,428,500원",
        "카카오선물하기 4/27~5/3 매출 752,700원 (주문금액-취소주문금액 기준)",
        "롯데온 4/27~5/3 판매금액 163,200원",
        "쿠팡 Ads 확인 매출 40,157,950원",
        "Cafe24 애널리틱스 4/27~5/3 매출 31,489,953원",
      ...
      check: [
        ...
        "Cafe24 자사몰 매출은 2026-04-27~2026-05-03 애널리틱스 매출 기준",
    ...
    status: [
      ...
      { type: "confirmed", text: "쿠팡 서플라이허브 전년 동요일 2025-04-28~2025-05-04: 수량 2,062개, 총단가 22,428,500원" },
      ...
      { type: "confirmed", text: "Cafe24 애널리틱스 2026-04-27~2026-05-03: 매출 31,489,953원" },
      ...
      { type: "confirmed", text: "Cafe24 API 주문 payment_amount 합계 26,117,821원은 애널리틱스 매출 기준과 달라 대시보드 기준에서 제외" },
    ...
    nextWeek: {
      ...
      issues: [
        ...
        "5월 2주차부터 Cafe24 API Pull 기간을 주차 전체 기준으로 고정",
...
const monthlyClosing = {
  "2026-04": {
    ...
    insights: {
      ...
      check: [
        "4월 채널 비중: 자사몰 48.7%, 쿠팡 45.6%, 스마트스토어 4.3%, 카카오선물하기 0.9%, 롯데온 0.5%",
